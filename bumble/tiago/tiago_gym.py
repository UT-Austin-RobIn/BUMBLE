...
from bumble.tiago.tiago_core import Tiago
from bumble.tiago.utils.general_utils import AttrDict
...
class TiagoGym(gym.Env):
    ...
    def reset(self, *args, **kwargs):
        ...
        skip_reset = kwargs.pop('skip_reset', False)
        if not skip_reset:
    ...
    def step(self, action, *args, **kwargs):
        ...
        if action is not None:
            info = self.tiago.step(action, *args, **kwargs)
